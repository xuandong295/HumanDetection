...
while True:
    ...
    output_layers_names = net.getUnconnectedOutLayersNames()          #['yolo_30', 'yolo_37'] #(class + 5) * 3
    ...
    for output in layerOutputs:     #có 2 output là kích thước (507,6) và (2028,6), mỗi hàng là 1 bouding box
    ...
    for i in range(len(boxes)):          #len(boxes) = 2
         ...
         cv2.putText(frame, "count: " + str(len(boxes)), (frame_width-140, frame_height-40), font, 1, color, 2)
         print(len(boxes))
